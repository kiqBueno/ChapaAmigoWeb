    ...
    <div className="importantInfoPage">
      <div className="importantInfo">
        ...
        <p>
          ...
          define o preço justo pelo serviço e recebe o pagamento diretamente do
          contratante. A plataforma assegura o cumprimento dos termos acordados
          através de recursos como chat, Ordens de Serviço e perfis verificados.
        </p>
        <p>
